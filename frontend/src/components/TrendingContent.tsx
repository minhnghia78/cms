...
import { usePostStore, listPostApi } from "../stores/postStores";
...
const trendingPosts: TrendingPost[] = [
  {
    id: "1",
    title:
      "MSI 2025 - G2 Meme Lord, LPL tấu hài, LCK đi du lịch, LCP thong thả",
  ...
  },
  {
    id: "2",
    title:
      "[CLB Chứng khoán] Chia sẻ kinh nghiệm đầu tư chứng khoán 2025 - Vì mục tiêu tăng trưởng 20%/năm",
  ...
  },
  {
    id: "3",
    title:
      "Arsenal FC Official VOZ: Mùa giải 2025-2026: Keep the Faith, Gunners!",
    author: "Karina (aespa)",
    replies: 7000,
    views: "27K",
